...
- Receive a validation object for each row of data with a validity indicator, list of error messages (one for each unmet validation criteria), field values, and line number
### Streaming
